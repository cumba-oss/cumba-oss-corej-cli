...
class CdiscValidateUsageTest
{
    ...
    private static final String[] USAGE_FRAGMENTS =
    {
            ...
            "exclude matching rule ids (repeatable)", "-ds, --dataset <name>[,<name>..]",
            ...
            "SDTM only; skips the API when it has the", "standard+version)",
            "External dictionaries:", "--dictionaries-dir <dir>",
            "installed-dictionary store (default:", "--snomed-version-select <v>",
            "--install-dictionaries", "--set-default", "--skip-installed", "--dry-run",
            "Java-only extras:", "--rules-dir <dir>", "rules directory", "--rules-file <file>",
            "extra rule package file (repeatable)", "--runtime-report <file>",
            "CSV file for per-(dataset, rule) runtime", "(default: <output>.runtime.csv; columns:",
    ...
    void helpBanner_containsAllFragmentsAndIsOrdered() throws Exception
    {
        ...
        // no discoverable fix.
        assertEquals(128, lineCount, "help banner line count changed: " + lineCount);
