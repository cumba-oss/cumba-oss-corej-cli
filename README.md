...
| Module | What it is |
|---|---|
| [`clients/cumba-oss-corej-cli`](clients/cumba-oss-corej-cli) | Headless CLI — load a study, run a rule package, write a JSON/XLSX report |
...
[README](clients/cumba-oss-corej-cli/README.md). The REST API is a Spring Boot
