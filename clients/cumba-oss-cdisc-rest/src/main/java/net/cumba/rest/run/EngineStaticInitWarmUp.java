...
import net.cumba.cdisc.core.metadata.DomainClassMap;
 ...
 * <li>{@code net.cumba.cdisc.core.gen.RuleGenerator} — class initialisation, kept in the warm-up so
...
public class EngineStaticInitWarmUp
{
     ...
     * here.
     */
    private static final String RULE_GENERATOR = "net.cumba.cdisc.core.gen.RuleGenerator";
