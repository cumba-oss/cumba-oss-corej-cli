...
import net.cumba.rest.report.ConformanceResponse;
import net.cumba.rest.report.DatasetGroupAssembler;
import net.cumba.rest.report.FileGroup;
import net.cumba.rest.report.FindingsPage;
import net.cumba.rest.report.ReportStore;
import net.cumba.rest.report.RuleReportRow;
import net.cumba.rest.report.RunArtifacts;
import net.cumba.rest.report.RunLog;
import net.cumba.rest.run.CheckRun;
import net.cumba.rest.run.CheckRunRequest;
import net.cumba.rest.run.RunConflictException;
import net.cumba.rest.run.RunExecutor;
import net.cumba.rest.run.RunRegistry;
import net.cumba.rest.run.RunStatus;
import net.cumba.rest.run.StudyValidationCheckRunner;
import net.cumba.rest.session.Session;
import net.cumba.rest.session.SessionRegistry;
import net.cumba.rest.web.dto.CheckStatusResponse;
import net.cumba.rest.web.dto.LiveLogResponse;
import net.cumba.rest.web.dto.StartCheckResponse;
...
public class CheckController
{
            ...
            @PathVariable("coreId") String coreId)
    {
        ...
        if (def == null)
        {
            throw new net.cumba.rest.run.RunNotFoundException(
