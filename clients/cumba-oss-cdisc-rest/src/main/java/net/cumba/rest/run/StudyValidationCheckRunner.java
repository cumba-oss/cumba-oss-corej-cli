...
import net.cumba.cdisc.core.run.ProgressListener;
...
public class StudyValidationCheckRunner implements CheckRunner
{
    ...
    private final net.cumba.rest.session.SessionRegistry sessions;

    private final net.cumba.rest.config.CorejProperties properties;

    private final RunLogDebugCapture debugCapture;

    public StudyValidationCheckRunner(net.cumba.rest.session.SessionRegistry sessions,
            net.cumba.rest.config.CorejProperties properties, RunLogDebugCapture debugCapture)
    {
