...
class RunLogDebugCaptureTest
{
    ...
    void capturesEngineDebugAndInfo()
    {
        ...
        try
        {
            System.Logger log = System.getLogger("net.cumba.cdisc.core.TestLogger");
    ...
    void capturesFromPropagatedWorkerThread() throws InterruptedException
    {
        ...
        try
        {
            ...
            Runnable raw = () -> System.getLogger("net.cumba.cdisc.core.Worker")
    ...
    void capturesNothingWhenNoSinkActive()
    {
        ...
        System.getLogger("net.cumba.cdisc.core.Idle").log(System.Logger.Level.DEBUG, "ignored");
    }
    ...
    void capturesEngineErrorEvenWithoutThrowable()
    {
        ...
        try
        {
            ...
            System.getLogger("net.cumba.cdisc.core.ErrTest").log(System.Logger.Level.ERROR,
                    "engine error line");
        }
        finally
        {
    ...
    void rendersThrowableStackTraceFrames()
    {
        ...
        try
        {
            ...
            System.getLogger("net.cumba.cdisc.core.TraceTest").log(System.Logger.Level.ERROR,
                    "rule failed", t);
        }
        finally
        {
    ...
    void capturesWarnAndInfoExactlyOnce()
    {
        ...
        try
        {
            System.Logger log = System.getLogger("net.cumba.cdisc.core.NoDup");
            ...
            java.util.concurrent.CountDownLatch ready, java.util.concurrent.CountDownLatch go)
    {
        ...
        System.getLogger("net.cumba.cdisc.core." + loggerLeaf).log(System.Logger.Level.INFO,
                message);
    }
}
